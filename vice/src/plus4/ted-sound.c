...
int machine_sid5_check_range(unsigned int sid3_adr)
{
    return 0;
}

int machine_sid6_check_range(unsigned int sid3_adr)
{
    return 0;
}

int machine_sid7_check_range(unsigned int sid3_adr)
{
    return 0;
}

int machine_sid8_check_range(unsigned int sid3_adr)
{
    return 0;
}
