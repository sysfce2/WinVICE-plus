...
static cmdline_option_t stereo_cmdline_options[] = {
    ...
    { "-sidquadaddress", SET_RESOURCE, 1,
      ...
      NULL, NULL },
    { "-sid5thaddress", SET_RESOURCE, 1,
      NULL, NULL, "Sid5thAddressStart", NULL,
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      IDCLS_P_BASE_ADDRESS, IDCLS_SPECIFY_SID_5_ADDRESS,
      NULL, NULL },
    { "-sid6thaddress", SET_RESOURCE, 1,
      NULL, NULL, "Sid6thAddressStart", NULL,
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      IDCLS_P_BASE_ADDRESS, IDCLS_SPECIFY_SID_6_ADDRESS,
      NULL, NULL },
    { "-sid7thaddress", SET_RESOURCE, 1,
      NULL, NULL, "Sid7thAddressStart", NULL,
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      IDCLS_P_BASE_ADDRESS, IDCLS_SPECIFY_SID_7_ADDRESS,
      NULL, NULL },
    { "-sid8thaddress", SET_RESOURCE, 1,
      NULL, NULL, "Sid8thAddressStart", NULL,
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      IDCLS_P_BASE_ADDRESS, IDCLS_SPECIFY_SID_8_ADDRESS,
      NULL, NULL },
    CMDLINE_LIST_END
};
