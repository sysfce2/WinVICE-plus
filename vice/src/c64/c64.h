...
/* PAL cycles per refresh: 19656 */
#define C64_PAL_CYCLES_PER_RFSH (C64_PAL_SCREEN_LINES * C64_PAL_CYCLES_PER_LINE)
/* PAL refresh rate: 50.124542124542124542124542124542 */
#define C64_PAL_RFSH_PER_SEC    ((double)C64_PAL_CYCLES_PER_SEC / (double)C64_PAL_CYCLES_PER_RFSH)
